...
background: gradient(left, rgba(28,28,28,1) 0%, rgba(31,31,31,1) 12%, rgba(36,36,36,1) 25%, rgba(26,26,26,1) 39%, rgba(15,15,15,1) 50%, rgba(0,0,0,1) 51%, rgba(5,5,5,1) 60%, rgba(15,15,15,1) 76%, rgba(10,10,10,1) 91%, rgba(5,5,5,1) 100%);
}
